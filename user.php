<?php 
  ...
  if (isset($_POST['btnEditUser'])) {
    if (editUser($_POST) > 0) {
      setAlert("Berhasil Diubah", "User telah diubah!", "success");
      header("Location: user.php");
    } else {
      setAlert("Gagal Diubah", "User gagal diubah!", "error");
      header("Location: user.php");
    }
  }
  ...
  if (isset($_POST['btnTambahUser'])) {
    if (addUser($_POST) > 0) {
      setAlert("Berhasil Menambahkan", "User berhasil ditambahkan!", "success");
      header("Location: user.php");
    }
  }
?>
                              ...
                              <form method="post">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                      <label for="username<?= $du['id_user']; ?>">Username</label>
                                      <input type="hidden" name="username_lama" value="<?= $du['username']; ?>"> <!-- Menyimpan username lama untuk validasi -->
                                      <input type="text" name="username" value="<?= $du['username']; ?>" id="username<?= $du['id_user']; ?>" class="form-control" required>
                                    </div>
                                    <div class="form-group">
