<?php 
  ...
  if (isset($_POST['btnEditSiswa'])) {
    if (editSiswa($_POST) > 0) {
      setAlert("Berhasil Diubah", "Mahasiswa telah diubah!", "success");
  ...
  if (isset($_POST['btnTambahSiswa'])) {
    if (addSiswa($_POST) > 0) {
      setAlert("Berhasil Menambahkan", "Mahasiswa berhasil ditambahkan!", "success");
      header("Location: siswa.php");
    }
  }
                              ...
                              <form method="post">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                      <label for="no_telepon<?= $ds['id_siswa']; ?>">NIM</label>
