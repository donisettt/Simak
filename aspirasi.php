<?php 
  ...
  checkLogin();
  $aspirasi = mysqli_query($conn, "SELECT * FROM aspirasi ORDER BY nama_lengkap ASC");
      ...
      <div class="container-fluid">
        <div class="row justify-content-center mb-2">
          <div class="col-sm text-left">
            <h1 class="m-0 text-dark">Aspirasi Mahasiswa</h1>
          </div><!-- /.col -->
          <div class="col-sm text-right">
            <?php if ($_SESSION['id_jabatan'] === '1' || $_SESSION['id_jabatan'] === '2' || $_SESSION['id_jabatan'] === '3'): ?>
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahAgendaModal"><i class="fas fa-fw fa-plus"></i> Tambah Aspirasi</button>
              <!-- Modal -->
          ...
          <div class="col-lg">
            <div class="table-responsive">
              <table class="table table-striped table-hover table-bordered" id="table_id">
                ...
                <tbody>
                  <?php $i = 1; ?>
                  <?php foreach ($aspirasi as $agd): ?>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $agd['invoice']; ?></td>
                      <td><?= ucwords(htmlspecialchars_decode($agd['nama_lengkap'])); ?></td>
                      <td><?= $agd['jenis_aspirasi']; ?></td>
                      <td><?= $agd['pesan_aspirasi']; ?></td>
                      <td><?= $agd['tanggal_pengajuan']; ?></td>
                      <td><?= $agd['status']; ?></td>
                      <?php if ($_SESSION['id_jabatan'] == '1' || $_SESSION['id_jabatan'] == '2'): ?>
                        <td>
